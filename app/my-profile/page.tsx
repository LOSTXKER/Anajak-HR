      ...
      const quotas: LeaveQuota[] = [
        {
          ...
          used: balanceData?.sick_leave_used || 0,
          remaining: balanceData?.sick_leave_remaining || (employee as any).sick_leave_quota || 30,
          color: "#ff3b30",
        },
        {
          type: "personal",
          ...
          used: balanceData?.personal_leave_used || 0,
          remaining: balanceData?.personal_leave_remaining || (employee as any).personal_leave_quota || 3,
          color: "#ff9500",
        },
        {
          type: "annual",
          ...
          used: balanceData?.annual_leave_used || 0,
          remaining: balanceData?.annual_leave_remaining || (employee as any).annual_leave_quota || 10,
          color: "#0071e3",
        },
      ];
